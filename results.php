...
<html>
    ...
    <?php
        ...
        <?php 
            ...
            if ($counter == 0){
                echo '<img class="end-results" src="img/stupid.jpg">';
            } else if ($counter <=10) {
                echo '<img class="end-results" src="img/read.jpg">';
            } else if ($counter >=10 && $counter < 15) {
                echo '<img class="end-results" src="img/alrighty-then.gif">';
            } else if ($counter >=15) {
                echo '<img class="end-results" src="img/seal.jpg">';
            } else if ($counter ==20) {
                echo '<img class="end-results" src="img/proud.jpg">';
            } 
?>
        <div class="side-bar">
            <a href="index.php">
            <img class="image" src="../img/try.png"></a>
        </div>
    </body>
</html>